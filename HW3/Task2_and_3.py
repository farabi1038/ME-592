...
dataset_path = '/Users/ibnefarabishihab/Desktop/Course Materials/ME 592/hw3/Leaf_Images'
...
dataset = torchvision.datasets.ImageFolder(root = dataset_path, transform=transform1)
